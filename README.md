...
***M.S. Computer Science @ Stony Brook University*** · ***Full-Stack Engineer*** · ***Distributed Systems***

---

## About

Software engineer with **2+ years** of industry experience building high-availability systems at scale. Currently researching **data platforms & NLP** as a Graduate Research Assistant at Stony Brook. Passionate about **distributed systems**, **data engineering**, and crafting performant backend services.

📍 Stony Brook, NY &nbsp;|&nbsp; 📬 rohan.kuckian@gmail.com
...
**Cloud & DevOps**
`AWS (EC2, S3)` `Docker` `Nginx` `CI/CD` `Git` `Linux`
...
- Cross-platform mobile app with **20× backend image retrieval improvement**
- Secured **90%+ of user data in transit** via AES encryption

---

## Education

**M.S. Computer Science** — Stony Brook University *(GPA: 3.74 / 4.0)* · 2024–2026
> Algorithms · Distributed Systems · HCI · Data Science

**B.E. Information Technology** — University of Mumbai · 2018–2022
> Databases · Web Dev · Software Engineering · AI

---

*Open to full-time SWE / Backend / Data Engineering roles starting **May 2026.***
